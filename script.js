...
const resumeData = {
    ...
    about: "Highly motivated software engineer with a passion for creating innovative solutions.",
    experience: [
        {
        ...
        },
        {
            ...
            description: "Contributed to the development of the core application and designed databases."
        }
    ],
    education: [
        {
